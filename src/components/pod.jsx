...
function Pod() {
  ...
  return (
    <div>
      <h2 className="text-center text-white m-2" style={{ backgroundColor: "#646464" }}>
        Подписка на новости
      </h2>
      <form className="w-50 m-auto p-3" style={{ minWidth: 300 }} onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn text-white" style={{ backgroundColor: "#0d6efd" }} disabled={loading}>
